    ...
    <div className="min-h-screen bg-gray-50 flex flex-col items-center justify-center p-4">
      <div className="w-full max-w-md space-y-8">
        ...
        <div className="text-center space-y-4">
          ...
          <div>
            <h1 className="text-2xl font-bold text-gray-900">Winnicode Garuda Teknologi</h1>
            <p className="text-gray-600 text-sm mt-1">Portal Jurnalistik dan Berita untuk Sistem Layanan Terpadu</p>
          </div>
        </div>
